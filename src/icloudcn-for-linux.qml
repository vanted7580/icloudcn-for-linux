...
Window {
  ...
  WebEngineView {
    ...
    url: "https://www.icloud.com.cn/" + Qt.application.arguments[1]
    ...
    onNewViewRequested: function(request) {
      ...
      if (target.startsWith('https://www.icloud.com.cn/')) {
        var newWindow = windowComponent.createObject(windowParent);
        newWindow.webView.zoomFactor = windowParent.zoomFactor / 0.8
        if (target.startsWith('https://www.icloud.com.cn/keynote') ||
            target.startsWith('https://www.icloud.com.cn/numbers') ||
            target.startsWith('https://www.icloud.com.cn/pages')) {
